...
from video_llama.datasets.datasets.my_dataset_with_audio import Video_Audio_Instruct_Dataset
...
@registry.register_builder("my_dataset_instruct")
class WebvidInstruct_Builder(Instruct_Builder):
    train_dataset_cls = Video_Audio_Instruct_Dataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/my_dataset/defaults.yaml",
    }
