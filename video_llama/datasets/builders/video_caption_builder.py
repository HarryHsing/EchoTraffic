...
from video_llama.datasets.datasets.internvid_datasets import InternvidDataset
...
@registry.register_builder("internvid")
class InternvidBuilder(BaseDatasetBuilder):
    train_dataset_cls = InternvidDataset
    DATASET_CONFIG_DICT = {"default": "configs/datasets/internvid/defaults.yaml"}
