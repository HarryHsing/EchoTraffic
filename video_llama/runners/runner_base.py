...
class RunnerBase:
        ...
        if self._model.device != self.device:
            ...
            if self.use_distributed:
                if self._wrapped_model is None:
                    # self._model, device_ids=[0,1,2,3,4,5,6,7]
                    # print("Harry: ", self.config.run_cfg.gpu)
    ...
    def dataloaders(self) -> dict:
        ...
        if self._dataloaders is None:
            ...
            self.data_len = math.ceil(self.data_len / batch_sizes[0] / self.config.run_cfg.world_size)
    ...
    @property
    def log_freq(self):
        log_freq = self.config.run_cfg.get("log_freq", 10)
        return int(log_freq)
