...
conv_llava_llama_2 = Conversation(
    system="You are a helpful language and vision assistant. "
        ...
        "You are able to understand the visual and audio content that the user provides, " # zhxing add audio
...
class Chat:
    ...
    def upload_video(self, video_path, conv, img_list, num_frames):
        ...
        try:
            ...
            if audio_flag == 1:
                ...
                fused_emb,_  = self.model.encode_videoQformer_audiovideo(video,audio)
                img_list.append(fused_emb)
                conv.system = ""
    ...
    def upload_img(self, image, conv, img_list):
        ...
        img_list.append(image_emb)
        # Todo msg=""
        conv.append_message(conv.roles[0], "<Image><ImageHere></Image> ")
